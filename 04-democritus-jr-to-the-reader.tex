...
will \worddef{delay}{tarry} and stand gazing like silly passengers at an antic picture
...
argument unlooked for, unthought of, and sells better than a \worddef{vulgar, obscene}{scurrile}
...
expect? How shall I that am \li{vix umbra tanti philosophi} hope to please?
...
scorn the rest. What therefore I have said, \li{pro tenuitate mea}, I have
said.
...
apologise, \lit{I pray}{deprecari}, and upon better advice give the friendly reader
notice: it was not mine intent to prostitute my muse in English, or to
\li{divulge secreta Minerv\ae{}}, but to have exposed this more contract in
...
\authormarginnote{134}Nicholas Car, in his oration of the \worddef{scarcity}{paucity} of English writers,
...
not revised the copy, and amended the style, which now flows \worddef{carelessly}{remissly},
as it was first conceived; but my leisure would not permit; \li{Feci nec
...
observed that precept of the poet, ---\li{nonumque prematur in annum}, and
...
that happy leisure, no \worddef{secretary, scribe}{amanuenses} or assistants. Pancrates in
Lucian\authormarginnote{137}, wanting a servant as he went from Memphis to Coptus in
...
it was first written \li{quicquid in buccam venit}, in an extemporean style,
as \authormarginnote{139}I do commonly all other exercises, \li{effudi quicquid dictavit
...
so much affect. I am \li{aqu\ae{}\ potor},\authormarginnote{141} drink no wine at all, which so
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{144.5}
\begin{verse}
...
in him. \li{Non est ornamentum virile concinnitas}: as he said of a
nightingale, ---\li{vox es, pr\ae{}terea nihil}, \etc. I am therefore in this
...
roscida cespitum, et glebosa camporum},\authormarginnote{147} through variety of objects,
that which thou shalt like and surely dislike.

For the matter itself or method, if it be faulty, consider I pray you
that of Columella, \li{Nihil perfectum, aut a singulari consummatum
...
masters. \li{Boni venatoris} (\authormarginnote{148}one holds) \li{plures feras capere, non
omnes}; he is a good huntsman can catch some, not all: I have done my
endeavour. Besides, I dwell not in this study, \li{Non hic sulcos ducimus,
...
friendly admonition, no bitter invective, \authormarginnote{151}\li{Sint musis socii
Charites, Furia omnis abesto}, otherwise, as in ordinary controversies,
\li{funem contentionis nectamus, sed cui bono?} We may contend, and likely
...
amend. \li{Si quid bonis moribus, si quid veritati dissentaneum, in sacris
...
\Seneca bear me out, \li{nunquam nimis dicitur, quod nunquam satis dicitur})
perturbations of tenses, numbers, printers' faults, \etc. My translations
are sometimes rather paraphrases than interpretations, \li{non ad verbum},
...
But I am now resolved never to put this treatise out again, \li{Ne quid
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{162}
\begin{verse}%
...
Marcilius Ficinus was \li{semel et simul}; a priest and a physician at once,
and \authormarginnote{165}T. Linacer in his old age took orders. The Jesuits profess
both at this time, diverse of them \li{permissu superiorum}, \worddef{surgeons}{chirurgeons},
...
to the study of genealogies, \li{penned theatrum genealogicum}. Or else I
...
the soul, and use diverse medicines to cure; one amends \li{animam per
corpus}, the other \li{corpus per animam} as \authormarginnote{168}our Regius Professor of
...
Jupiter in my sixth house; I say with \authormarginnote{170}Beroaldus, \li{non sum medicus,
...
had built six castles, \li{ad invidiam operis eluendam}, saith \authormarginnote{171}Mr.
...
fully considered of the matter of this my subject, \li{rem substratam},
...
discovery as that hungry \authormarginnote{172}Spaniard's of \lit{the Unknown Land of Australia}{Terra Australis Incognita},
...
than good. I advise them therefore warily to peruse that tract, \li{Lapides
loquitur} (so said \authormarginnote{175}Agrippa de occ. Phil.) \li{et caveant lectores ne
...
map) made like a fool's head (with that motto, \li{Caput helleboro dignum})
a crazed head, \li{cavea stultorum}, a fool's paradise, or as Apollonius, a
...
table, \li{omnes errorem bibunt}, before they come into the world, they are
...
\li{Qui nil molitur inepte}, who is not brain-sick? Folly, melancholy,
madness, are but one disease, Delirium is a common name to all.

Alexander, Gordonius, Jason Pratensis, Savanarola, Guianerius,
Montaltus, confound them as differing \li{secundum magis et minus}; so doth
David, Psal. \rn{xxxvii.} 5. I said unto the fools, deal not so madly, and
'twas an old Stoical paradox, \li{omnes stultos insanire}, \authormarginnote{179}all fools
...
\li{omnium insipientum animi in morbo sunt, et perturbatorum}, fools are
...
of spirit. And though he were the wisest man in the world, \li{sanctuarium
...
without laws, \li{Audabatarum instar}, \etc. Folly, rash and inconsiderate,
...
\authormarginnote{189}\Pliny{}'s time, \li{fuerunt et alii, similis dementi\ae{}}, \etc. And called
not long after, \authormarginnote{190}\li{Vesani\ae{}\ sectatores, eversores hominum, polluti
...
cannot, or will not lie and dissemble, shift, flatter, \li{accommodare se
ad eum locum ubi nati sunt}, make good bargains, supplant, thrive,
\li{patronis inservire; solennes ascendendi modos apprehendere, leges,
...
none present, before, or after Socrates, \li{nemo veterum neque eorum qui
...
\li{Non doctus, sed natus sapiens}, wise from his cradle, Eoicuras so much
...
illiterate, \li{Eunuchi sapienti\ae{}.} And although they were the wisest, and
...
Lactantius, in his book of wisdom,\authormarginnote{199} proves them to be dizzards,
...
saith he, the inheritance of his folly to Epicurus, \authormarginnote{201}\li{insanienti dum
...
\authormarginnote{204}Aristophanes calls him, \li{irriscor et ambitiosus}, as his master
...
convict by Anytus) \li{iracundus et ebrius, dicax}, \etc a pot-companion, by
...
dotage, which Tully ad Atticum long since observed, \li{delirant plerumque
...
limits, divide and subdivide, but cannot yet prescribe \li{quantum homini
...
\li{quid in vita rectum sit, ignorant}; so that as he said, \li{Nescio an
...
souls are tormented in hell fire. In some sense, \lit{Christians are Crassians}{Christiani Crassiani},
and if compared to that wisdom, no better
than fools. \li{Quis est sapiens? Solus Deus}, \authormarginnote{211}Pythagoras replies, God
...
we are all fools, and the \authormarginnote{212}\li{Scripture alone is arx Minerv\ae{}}, we and
...
\authormarginnote{214}Hugo de Prato Florido will have it, \li{semper stultizat}, is every day
...
in it, \li{asini bipedes}, and every place is full \li{inversorum Apuleiorum} of
metamorphosed and two-legged asses, \li{inversorum Silenorum}, childish,
\li{pueri instar bimuli, tremula patris dormientis in ulna.} Jovianus
Pontanus, Antonio Dial, brings in some laughing at an old man, that by
reason of his age was a little fond, but as he admonisheth there, \li{Ne
mireris mi hospes de hoc sene}, marvel not at him only, for \li{tota h\ae{}c
...
man, but what madness ghosts us all? For we are \li{ad unum omnes}, all mad,
\li{semel insanivimus omnes} not once, but alway so, \li{et semel, et simul, et
semper}, ever and altogether as bad as he; and not \li{senex bis puer,
delira anus}, but say it of us all, \li{semper pueri}, young and old, all
dote, as Lactantius proves out of \Seneca; and no difference betwixt us
and children, saving that, \li{majora ludimus, et grandioribus pupis}, they
...
ourselves, \li{deliramenta loqueris}, you talk idly, or as \authormarginnote{217}Mitio
upbraided Demea, \li{insanis, auferte}, for we are as mad our own selves,
...
\authormarginnote{223}They dote all, but not alike, \textgreek{Μανία γαρ πᾶσιν ὁμοια}, not in the
...
'Tis an inbred malady in every one of us, there is \li{seminarium
stultiti\ae{}}, a seminary of folly, which if it be stirred up, or get
ahead, will run \li{in infinitum}, and infinitely varies, as we ourselves
are severally addicted, saith \authormarginnote{225}Balthazar Castilio: and cannot so
easily be rooted out, it takes such fast hold, as Tully holds, \li{alt\ae{}
...
impinge on some one kind or other. \authormarginnote{227}\li{Sic plerumque agitat stultos
...
idiots, asses, \li{O stulti, qu\ae{}nam h\ae{}c est amentia?} O fools, O madmen,
he exclaims, \li{insana studia, insani labores}, \etc{}. Mad endeavours, mad
actions, mad, mad, mad, \authormarginnote{229}\li{O s\ae{}clum insipiens et infacetum}, a
...
Princes commend a private life;\authormarginnote{243} private men itch after honour: a
...
\authormarginnote{258}\idxname{Salisburiensis} said in his time, \li{totus mundus histrionem agit}, the
whole world plays the fool; we have a new theatre, a new scene, a new
comedy of errors, a new company of personate actors, \li{volupi\ae{}\ sacra} (as
...
philosopher another, in his \li{volupi\ae{}\ ludis}; a king now with his crown,
...
come in such pomp and state, rose up to give him place, \li{ex habitu
...
Stultos avaros, sycophantas prodigos.%\authorlatintrans{262} 
\end{verse}
\end{latin}
\translationrule
\poemlines{0}
...
his belly with laughing. \authormarginnote{263}\li{Si foret in terris rideret Democritus,
seu}, \etc{}. A satirical Roman in his time, thought all vice, folly, and
madness were all at full sea, \authormarginnote{264}\li{Omne in pr\ae{}cipiti vitium stetit}.
...
they do still: we keep our madness still, play the fools still, \li{nec dum
...
\li{Religiosam insaniam}, so many professed Christians, yet so few imitators
...
such variety of sects, such have and hold of all sides, \authormarginnote{271}-\li{obvia
...
poor Peter's successor, \li{servus servorum Dei}, to depose kings with his
...
\li{Coelum ipsum petitur stultitia.} Had he met some of our devout pilgrims
...
yet indeed a notorious bawd, and famous fornicator, \li{lascivum pecus}, a
...
traitors, assassinats, \li{hac itur ad astra}, and this is to supererogate,
...
indifferent (they alone are the true Church, \li{sal terr\ae{}, cum sint
...
fear, \li{quo se cunque rapit tempestas}, to credit all, examine nothing,
...
mills: \li{unius ob noxam furiasque}, or to make sport for princes, without
...
hewing, massacres, murders, desolations-\li{ignoto coelum clangore remugit},
...
worlds for him to conquer, he is admired by some for it, \li{animosa vox
videtur, et regia}, 'twas spoken like a Prince; but as wise \authormarginnote{320}\Seneca
...
affinity, \worddef{having blood relation}{consanguinity}, Christianity, can contain them, but if they be
...
more, to devour houses and towns, or as those \lit{Man-eaters}{Anthropophagi}, to
...
corruption, fraud and \worddef{deception, trickery}{cozenage}, and liberally to distribute to the poor
...
follies and absurd fopperies of that sect, force him to say, \li{veris
...
too forward, too ripe, \li{pr\ae{}properi}, too quick and ready, \authormarginnote{428}\li{cito
...
bad, covetous, litigious generation of men. \authormarginnote{502}\li{Crumenimulga natio} \etc{}.
