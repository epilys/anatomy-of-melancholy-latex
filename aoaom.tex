\documentclass[16pt,letter,oneside,usenames,dvipsnames]{memoir}
  \usepackage{polyglossia}
  \usepackage{fontspec}
  \setmainlanguage{english}
  \setotherlanguage{greek}
  \setmainfont[Scale=1.20]{Junicode}
...
\setminted[tex]{breaklines=true,linenos=true,bgcolor=bgcolor}
\setminted[shell]{breaklines=true,linenos=true,bgcolor=bgcolor}
