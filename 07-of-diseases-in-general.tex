...
\begin{figure}[H]
  \centering
  \includegraphics[keepaspectratio,width=0.9\textwidth]{figures/MelancholicTemperament-small.jpg}
  \caption{\citeart{MelancholicTemperament}}
...
14.
\subsection{Fruits.}
\inlinelatin{Pastinacarum usus succos gignit improbos}. Crato, consil. 21.
...
\mmarginpar{1374}Nicholas Piso in his \emph{Practics}, forbids all fruits, as windy, or
...
likewise rejected.
\subsection{Pulse.}
All \margindef{Dried legume}{pulse} are naught, beans, peas, vetches, \etc{}, they fill
...
In this catalogue of passions, which so much torment the soul of man, and cause
...
inseparable companion, \mmarginpar{1637}The mother and daughter of melancholy,
...
That it is a cause all the world acknowledgeth, \inlinelatin{Dolor nonnullis insaniae causa
...
mournful duchess (in our English Ovid\mmarginpar{1644}), laments to her noble
...
\begin{figure}[H]
  \centering
  \includegraphics[keepaspectratio,width=0.7\textwidth]{figures/thais-small.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[keepaspectratio,width=0.8\textwidth]{figures/memento-mori-small.jpg}
  \caption{\citeart{MementoMori}}
...
\begin{figure}[H]
  \centering
  \includegraphics[keepaspectratio,width=0.8\textwidth]{figures/nvidia-small.jpg}
  \caption{\citeart{Invidia}}
  \label{fig:invidia}
\end{figure}
...
---\textlatin{intabescitque videndo\\
  Successus hominum-suppliciumque suum est.}\mmarginpar{1695}
\end{verse}
...
καὶ ἀοίδος ἀοιδῶ.}\mmarginpar{1715}
\end{verse}
...
\textlatin{Qui cecidit, stabili non erat ille gradu.}\mmarginpar{1779}
\end{verse}
...
\textlatin{Suppositos cineri doloso},\mmarginpar{1793}
\end{verse}
...
\textlatin{Delassare valent Fabium}.---\mmarginpar{1797}
\end{verse}
...
\section[Φιλαυτία, or Self-love]{Φιλαυτία, or Self-love, Vainglory, Praise, Honour, Immoderate Applause, Pride, overmuch Joy, \etc{}, Causes.}
...
lau\-de\-tur (saith \mmarginpar{1954}Erasmus) cristas erigit, exuit hominem, Deum se
...
\begin{figure}[H]
  \centering
  \includegraphics[keepaspectratio,width=0.6\textwidth]{figures/scholar-small.jpg}
  \caption{\citeart{Scholar}}
  \label{fig:scholar}
\end{figure}
...
would marry her, quod indotato, fair Psyche had no money. So they
do by learning;\mmarginpar{2080}

\textlatin{
\begin{verse}
---didicit jam dives avarus\\
Tantum admirari, tantum laudare disertos,\\
Ut pueri Junonis avem---\mmarginpar{2081}
\end{verse}
}
...
Doctores enim et professores (quod ait \mmarginpar{2088}ille) id unum curant, ut ex professionibus
...
dicam, pecuniosi sint. \mmarginpar{2090}Phi\-lo\-so\-pha\-stri li\-ce\-nti\-antur in artibus,
...
\mmarginpar{2092}Paulus ait, sed cauponantes verbum Dei.
...
\mmarginpar{2096}Opiniones quasvis et decreta contra verbum Dei astruunt, ne non offendant patronum, sed ut retineant
...
be still accompanied with that \mmarginpar{2181}\textgreek[variant=ancient]{ἀβλάβεια} or innocency, quae nemini
...
\begin{figure}[H]
  \centering
  \includegraphics[keepaspectratio,width=0.8\textwidth]{figures/carrying-povery-small.jpg}
  \caption{\citeart{PovertyRiches}}
