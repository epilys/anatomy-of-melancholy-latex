...
\end{verse}%
\end{latin}
\translationrule%\setauthornote{1573.5}
\begin{verse}%
...
\end{verse}
\end{latin}
\translationrule%\authorlatintrans{1695.5}
...
\begin{greek}
\begin{verse}
Καὶ κεραμεὺς κεραμεῖ κοτέει\\*
καὶ τεκτονι τέκτων,\\*
Καὶ πτωχὸς πτωχῷ φθονέει\\*
καὶ ἀοίδος ἀοιδῶ.\\!
\end{verse}
\end{greek}
\translationrule%
...
\end{verse}%
\end{latin}
\translationrule%\setauthornote{1718.5}
\begin{verse}%
...
\end{verse}%
\end{latin}
\translationrule%\setauthornote{1759.5}
\begin{verse}%
...
\authorfootnote{1852}crescunt divitiae, \li{tamen curtae nescio quid semper abest rei}: his
...
an endless misery; \li{in quem scopulum avaritiae cadaverosi senes
...
venandi studium}, one calls it, \li{insanae substructiones}: their mad
...
knees, some to the girdle, some to the chin, \li{pro modo insaniae}, as they
...
\li{Munera fortunae, sed insidiae} as that wise \Seneca determines, not
...
nothing of those prodigious prodigals, \li{perdendae pecuniae, genitos}, as
...
\end{verse}%
\end{latin}
\translationrule%\authorlatintrans{1896.5}
\begin{verse}%
...
\li{Matrem praegnantem nequiter oppressit, sororem violare voluit, patrem
...
him, \li{Vino dari laetitiam et dolorem}, drink causeth mirth, and drink
...
\li{Quamquam O}! \etc{} and that vainglorious \authorfootnote{1927}orator is not ashamed to
...
\end{verse}%
\end{latin}
\translationrule%\setauthornote{2169.5}
\begin{verse}%
...
Charles V., \li{ad mortem fere melancholicus}, saith Guicciardini,
