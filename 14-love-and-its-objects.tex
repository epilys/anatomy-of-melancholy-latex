...
\begin{figure}[p!]
  \begingroup
  \centering
  \includegraphics[keepaspectratio,width=\textwidth]{The-Love-Song-Edward-Burne-Jones-small.jpg}
...
by reason of his riper years sooner divert. Besides, \li{nihil in hac
...
which I may not omit; \li{operi suscepto inserviendum fuit}: so Jacobus
...
For my part, saith \authorfootnote{4423}Maximus Tyrius, a great Platonist himself, \li{me
...
\li{Quod Junonem cum Jove in Ida concumbentes inducit, ab immortali nube
contectos}, Vulcan's net. Mars and Venus' \worddef{obsessed about appearances}{fopperies} before all the gods,
...
Plato, by his testimony, writ lighter themselves: \li{quid enim tam distat}
(as he follows it) \li{quam amans a temperante, formarum admirator a
...
weary readers, to expatiate in this delightsome field, \li{hoc deliciarum
campo}, as Fonseca terms it, to \authorfootnote{4431} season a surly discourse with a
more pleasing aspersion of love matters: \li{Edulcare vitam convenit}, as
the poet invites us, \li{curas nugis}, \etc{}, 'tis good to sweeten our life
with some pleasing toys to relish it, and as \Pliny{} tells us, \li{magna pars
...
I will not \worddef{imperatively}{peremptorily} say as one did \authorfootnote{4435}\li{tam suavia dicam facinora,
...
will not expert or hope for that \worddef{approval}{approbation}, which Lipsius gives to
...
please; \li{non tam ut populo placerem, quam ut populum juvarem}, and these
...
old poets besides, did in \li{scriptis prurire}, write Fescennines,
Atellans, and lascivious songs; \li{laetam materiam}; yet they had in
\li{moribus censuram, et severitatem}, they were chaste, severe, and upright
livers.
...
\end{verse}%
\end{latin}
\translationrule%\setauthornote{4442}
\begin{verse}%
...
hood, when she was consulted by Jupiter about Mercury's marriage, \li{quod,
...
profane writer, qui tam atrociter (\authorfootnote{4448}one notes) \li{hoc genere
...
confess it, with a good \authorfootnote{4450}author, \li{quod extendi et locupletari hoc
...
\end{verse}%
\end{latin}
\translationrule%\setauthornote{4451.5}
\begin{verse}%
I am compelled to reverse my sails,
and retrace my former course.
\end{verse}%
\attrib{\getauthornote{4451}}

\li{etsi non ignorarem novos fortasse detractores novis hisce
interpolationibus meis minime defuturos}\authorlatintrans{4452}.
...
of it; \li{Omnia munda mundis}, \authorfootnote{4457}a naked man to a modest woman is no
...
Scaliger besought Cardan (\li{si quid urbaniuscule lusum a nobis, per deos
...
\li{Per Musas et Charites, et omnia Poetarum numina, benigne lector, oro te
...
well of it, and wish me good success. \li{Extremum hunc Arethusa mihi
concede laborem}\authorlatintrans{4460}.

I am resolved howsoever, \li{velis, nolis, audacter stadium intrare}, in the
...
attendant, as Picolomineus holds, or as Nich. Caussinus, the \li{primum
...
to them seems to be good; \li{quid enim vis mali} (as \Austin{} well infers)
\li{dic mihi? puto nihil in omnibus actionibus}; thou wilt wish no harm, I
suppose, no ill in all thine actions, thoughts or desires, \li{nihil mali
...
love; for as Proclus holds, \li{Omne pulchrum amabile}, every fair thing is
...
neoterics, have written just volumes, \li{De amore Dei}, as they term it,
many paraenetical discourses; another from his creatures; there is a
beauty of the body, a beauty of the soul, a beauty from virtue, \li{formam
martyrum}, \Austin{} calls it, \li{quam videmus oculis animi}, which we see with
the eyes of our mind; which beauty, as Tully saith, if we could discern
with these corporeal eyes, \li{admirabili sui amores excitaret}, would cause
...
liver. \li{Amor et amicitia}, which Scaliger \li{exercitat}. 301. Valesius and
...
around, \authorfootnote{4489}\li{Amantes naturae, debita exercere}, for love of perfection.
...
but for love? No creature, S. Hierom concludes, is to be found, \li{quod
...
vine and the cabbage, between the vine and the olive, \authorfootnote{4490} \li{Virgo
...
the mutual agreement, as being of the same kind: \li{Sus sui, canis cani,
bos bovi, et asinus asino pulcherrimus videtur}, as Epicharmus held, and
according to that adage of Diogenianus, \li{Adsidet usque graculus apud
graculum}, they much delight in one another's company, \authorfootnote{4493}\li{Formicae
...
The third kind is \li{Amor cognitionis}, as Leon calls it, rational love,
\li{Intellectivus amor}, and is proper to men, on which I must insist. This
...
world. \li{Amor mundum fecit}, love built cities, \li{mundi anima}, invented
...
\worddef{crudeness}{rusticity}; \li{Circulus a bono in bonum}, a round circle still from good to
...
\li{Charior est ipsis homo quam sibi}.\authormarginnote{4500} Not that we are fair, nor for
...
their well wishes reflect on us, \authorfootnote{4502}\li{in salute hominum promovenda
...
%MEMB. II. SUBSECT. I.-_Love of Men, which varies as his Objects, Profitable, Pleasant, Honest_.
...
to these three, \li{utile, jucundum, honestum}, profitable, pleasant,
...
lustre it hath; \li{gratius aurum quam solem intuemur}, saith \Austin{}, and we
...
burdens, all are made light and easy by this hope of gain: \li{At mihi
...
\li{Formosior auri massa}, as \authorfootnote{4513} he well observed, the mass of gold is
...
discontent, miserable, desperate, and mad. Our estate and \lit{bene esse}{well-being}
...
acquaintance can contain us, but \authorfootnote{4517}\li{rupto jecore exierit Caprificus}.
...
a caterpillar, a viper, a hog-rubber, \etc{} \li{Desinit in piscem mulier
formosa superne}\authorlatintrans{4518}; the scene is altered on a sudden, love is turned
...
cities, as he said, \authorfootnote{4521}\li{Pulcherrimam insulam videmus, etiam cum non
...
lustre: we admire, and gaze upon them, \li{ut pueri Junonis avem}, as
children do on a peacock: a fair dog, a fair horse and hawk, \etc{}

\authorfootnote{4525}\li{Thessalus amat equum pullinum, buculum Aegyptius, Lacedaemonius
...
\worddef{gourmand}{epicure} on his several pleasures, the superstitious on his idol, and
...
(\li{quod me tibi temperat astrum?}) They do singularly dote on such a man,
hate such again, and can give no reason for it. \authorfootnote{4527}\li{Non amo te
...
\worddef{one third of a circle}{trine} and \worddef{one sixth of a circle}{sextile} aspects, or opposite of their several ascendants,
...
commonly in their courts. But \authorfootnote{4530}\li{Pares cum paribus facillime
...
(\li{acerba calamitatum societas, diversi etiam ingenii homines
conjungit})\authorfootnote{4534} affinity, or some such accidental occasion, though they
...
A third cause of love and hate, may be mutual offices, \li{acceptum
...
and Casaubonus: \li{mulus mulum scabit}; who but Scaliger with him? what
\worddef{eulogies}{encomiums}, epithets, eulogiums? \li{Antistes sapientiae}, \li{perpetuus
dictator}, \li{literarum ornamentum}, \li{Europae miraculum}, noble Scaliger,
\authorfootnote{4537} \li{incredibilis ingenii praestantia}, \etc{}, \li{diis potius quam
...
friends; if thine estate be good, and thou able, \li{par pari referre}, to
...
alone, as men love women with a wanton eye: which \textgreek{κατ' ἐξοχὴν}\inlinetrans{prominently} is termed
...
\worddef{counterfeit}{fucate}, but proceeding from true form, and an incorrupt judgment; those
two Venus' twins, Eros and Anteros, are then most firm and fast. For
many times otherwise men are deceived by their flattering \worddef{jaw}{gnathos},
...
the hearts and favours of men, and deceive them, \li{specie virtutis et
umbra}, when as \lit{revera}{in fact} and indeed, there is no worth or honesty at all
...
times, \etc{} as I shall elsewhere discuss.\authormarginnote{4543} The true object of this
honest love is virtue, wisdom, honesty, \authorfootnote{4544}real worth, \li{Interna
forma}, and this love cannot deceive or be compelled, \li{ut ameris amabilis
esto}, love itself is the most potent philtrum, virtue and wisdom,
\li{gratia gratum faciens}, the sole and only grace, not counterfeit, but
...
which is the \lit{primum mobile}{first mover}, and a most forcible loadstone
...
Orpheus, \li{quo vult, unde vult}, he pulls them to him by speech alone: a
...
For which cause belike, our old poets, Senatus \li{populusque poetarum},
...
beauty of Socrates; yet who was more grim of \worddef{facial expression}{countenance}, stern and
...
seen. \li{Saepe sub attrita latitat sapientia veste.} Aesop, \Democritus{},
...
living was so fair as Alcibiades, so lovely \li{quo ad superficiem}, to the
eye, as \authorfootnote{4548}Boethius observes, but he had \li{Corpus turpissimum interne},
...
\li{magnificoes} of his time, \li{injecta ei vestis purpura auroque distincta}, a
\editornote{purple was considered a regal colour, worn in the Roman Republic, \emph{\textlatin{Imperium Romanum}}, and the Catholic Church}{purple} embroidered garment was put upon him, \authorfootnote{4550}and they bade him
...
\li{multas haereditates} (\authorfootnote{4551}Cornelius Nepos writes) \li{sola bonitate
consequutus}. \li{Operae, pretium audire}, \etc{} It is worthy of your
...
for valour, \authorfootnote{4553} H\ae{}phestion loved Alexander, but Parmenio the king:
\li{Titus deliciae humani generis}, and which Aurelius Victor hath of
...
sweet, and we love them many ages after, though they be dead: \li{Suavem
...
one fair, \li{et incomparabiliter pulchrior est} (as \Austin{} holds) \li{veritas
...
\worddef{dwelling}{bower}, and kissed him sweetly; when the young ladies laughed at her for
...
and so doth Baradius and Peter Morales, lib de pulchritud. \li{Jesu et
Mariae}, adding as much of Joseph and the Virgin Mary, \li{haec alias forma
praecesserit omnes}\authorlatintrans{4566}, according to that prediction of Sibylla
...
Brachmanni, \worddef{\emph{literally} naked philosophers, a name given to ancient Indian philosophers and ascetics}{gymnosophists}. The Queen of Sheba came to visit Solomon;
and many, saith \authorfootnote{4567}Hierom, went out of Spain and remote places a
thousand miles, to behold that eloquent Livy: \authorfootnote{4568}\li{Multi Romam non ut
...
\end{verse}%
\attrib{\getauthornote{4570}}

Many, saith Phavorinus, that loved and admired Alcibiades in his youth,
knew not, cared not for Alcibiades a man, \li{nunc intuentes quaerebant
Alcibiadem}; but the beauty of Socrates is still the same;
\authorfootnote{4571}virtue's lustre never fades, is ever fresh and green, \li{semper viva}
...
perfect amity, a \worddef{\emph{literally} a Pythagorean musical interval, \emph{figuratively} a burst of harmony}{diapason} of vows and wishes, the same opinions, as
...
their friends are dead, with tombs and monuments, \worddef{funeral songs}{nenias}, epitaphs
...
Plato's scholars did) they will \lit{parentare}{sacrifice in honour of the dead} still, omit no good office
...
glory, and eternity? But that which he wrote \worddef{\emph{adverb} perhaps}{peradventure} will not
...
persecute them with satires, \worddef{insulting words}{invectives}, \etc{}, and 'tis both ways of
...
to make a more \worddef{splendid, expensive}{sumptuous} monument, I will perform those rites to his
...
feared than beloved; \li{nec amant quemquam, nec amantur ab ullo}: and
...
hypocrites, such \worddef{bide one's time}{temporising} foxes, and \worddef{blur}{blear} the world's eyes by
...
set them in slippery places, Psal. \rn{xxxvii.} 5. as so many \editornote{Sejanus, friend and officer of Roman Emperor Tiberius. Suspected for conspiracy against Tiberius, he was executed and thrown down the Gemomnian stairs in Rome}{Sejani}, they
will come down to the Gemonian scales; and as Eusebius in \authorfootnote{4585}
Ammianus, that was in such authority, \li{ad jubendum Imperatorem}, be cast
...
libels, and bitter imprecations, they shall \li{male audire} in all
...
\worddef{love; loving kindness}{dilection}, benevolence, friendship, even all those virtuous habits; for
...
for this love is \li{lychnus accendens et accensus}, a communicating light,
...
a man to love his parents, (\li{dii me pater omnes oderint, ni te
magis quam oculos amem meos!})\authorfootnote{4588} and this love cannot be dissolved, as
...
happily concur; yet this love comes short of it. \li{Dulce et decorum
pro patria mori}\authorlatintrans{4591}, \authorfootnote{4592}it cannot be expressed, what a deal of charity
that one name of country contains. \li{Amor laudis et patriae pro stipendio
est}; the Decii did \li{se devovere}, Horatii, Curii, Scaevola, Regulus,
...
soul, if it be not done in \li{ordine ad Deum} for God's sake. Though I had
...
this our love make an \worddef{unbreakable}{indissoluble} twist, a Gordian knot, an
...
atonement, and reconciles us unto him.\authorfootnote{4607} That other love infects %FIXME note placement, που ανήκει;
...
\li{invicem angariare}, contemn, consult, vex, torture, molest, and hold one
...
snarling fit. \li{Eris dea} is settled in our tents, \authorfootnote{4612}\li{Omnia de lite},
...
not how we get it, \li{Quocunque modo rem}; how many thousands we undo, whom
...
Swear, protest, take God and all his angels to witness, \li{quaere
peregrinum}, thou art a counterfeit crank, a cheater, he is not touched
with it, \li{pauper ubique jacet}, ride on, he takes no notice of it. Put up
...
injuries, as true charity requires; yet most part there is \li{simulatum
...
examine this \authorfootnote{4620}iron age wherein we live, where love is cold, \li{et jam
