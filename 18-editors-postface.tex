...
\begin{figure}[H]%
  ...
  \qquad\begin{minipage}{0.3\textwidth}%
    \frame{\includegraphics[quiet=true,keepaspectratio]{first-page-first-edition-small.jpg}}
    \caption*{\scriptsize{}First page.}
  \end{minipage}%
  \qquad\begin{minipage}{0.3\textwidth}%
    \frame{\includegraphics[quiet=true,keepaspectratio]{marginalia-page-first-edition-small.jpg}}
...
\begin{figure}[H]%
  ...
  \qquad\begin{minipage}{0.27\textwidth}%
   ...
   \caption*{\scriptsize{}Topical diagram (First edition 1621).}
  \end{minipage}%
  \qquad\begin{minipage}{0.27\textwidth}%
     ...
     \caption*{\scriptsize{}\autopageref{ch:synopsis-of-first-part}.}
     \end{minipage}
  \end{minipage}%
