...
\newcommand\mmarginpar[1]{\hyperref[#1]{\textsuperscript{\scriptsize{}\textrm{[#1]}}}\marginnote{\setstretch{0.6}\scriptsize{}\textrm{[#1]}\label{#1} \csuse{marginnote#1}}}
\usepackage{metalogo}
...
%\includeonly{00-frontispiece-legend,00-about-the-author,02-the-argument-of-the-frontispiece}
\begin{document}
\frontmatter
...
\include{04-democratus-jr-to-the-reader-notes}
