...
% Vergil is sometimes spelled Virgil, so this might be confused with the Roman Virgil:
\csdef{name:polydorevergil}{Polydore Vergil}%
...
\bookmarksetup{startatroot}
%\protect\nocite{*}
\defbibnote{introduction}{All artwork in the public domain.}
\printbibliography[prenote=introduction,heading=bibnumbered,title={Artwork Sources}]
