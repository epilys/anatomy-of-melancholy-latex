...
\setmainfont[Ligatures=Required,
             ...
             SizeFeatures={
               {Size={-10},OpticalSize=5,Ligatures=Discretionary,StylisticSet={18,11,06},Numbers={Proportional}},
               {Size={10-}},
             },
             ]{Junicode}
...
\newcommand\latininlinetrans[2]{\emph{\textlatin{#1}}{\color{maroon}\ \textit{[#2]}\xspace}}
