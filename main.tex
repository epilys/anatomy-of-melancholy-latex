...
\usepackage{float}
\usepackage[]{caption}
\captionsetup{parskip=0pt,justification=centering,font=small,labelformat=empty,labelsep=none,textformat=simple}
% original is 28.0pt plus 2.0pt minus 4.0pt.
