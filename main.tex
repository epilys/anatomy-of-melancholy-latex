...
\usepackage{alphalph}
\renewcommand{\thefootnoteA}{\emph{\alphalph{\value{footnoteA}}}}
...
\newcommand\authormarginnote[1]{\textsuperscript{\normalfont{}\junicodenormalnumerals{}#1}\marginnote{{\junicodenormalnumerals{}#1}.\ \csuse{authornote#1}}}
...
% Predefine author names that have non-modern spelling in text
