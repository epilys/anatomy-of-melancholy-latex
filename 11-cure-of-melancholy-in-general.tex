...
\begin{figure}[h]
  \begingroup
  \centering
  \includegraphics[keepaspectratio,width=0.8\textwidth]{tantalus.jpg}
  \captionart{Tantalus}
  \label{fig:tantalus}
\end{figure}
...
overcame this conceit, \lit{quid cani cum balneo?}{what should a dog do in a bath?}
...
\begin{figure}[p]
  \begingroup
  \centering
  \includegraphics[keepaspectratio,width=\textwidth]{DancingCouple.jpg}
  \captionart{DancingCouple}
