...
\begin{latin}%
\begin{prescriptionbox}{\marginrecipe{℞: Prescribe}}{mane facta collatura exhibe}
\item Syrupe de pomis ℥\marginrecipe{℥: ounce}ij,
\item aqu\ae{} borag ℥iiij
\item Ellebori nigri per noctem infusi in ligatura 6 vel 8 gr.
\end{prescriptionbox}%
\end{latin}%
\end{minipage}%
\begin{minipage}[c]{0.4\textwidth}
...
\begin{minipage}[c]{0.4\textwidth}%
\begin{latin}%
\begin{prescriptionbox}{}{omnia, et ipsius pulveris scrup. 4. singulis septimanis assumat.}
\item epithymi semunc. lapidis lazuli,
\item agarici ana ℥ij,
\item Scammnonii ʒj,
\item caryophyllorum numero 20; pulverisentur,
\end{prescriptionbox}%
\end{latin}%
\end{minipage}%
\begin{minipage}[c]{0.4\textwidth}
...
\begin{minipage}[c]{0.4\textwidth}%
\begin{latin}%
\begin{prescriptionbox}{}{misce, fiat pulvis.}
\item Epithymi, thymi, ana drachmas duas,
\item sacchari albi unciam unam,
\item croci grana tria,
\item Cinamomi drachmam unam
\end{prescriptionbox}%
\end{latin}%
\end{minipage}%
\begin{minipage}[c]{0.4\textwidth}
...
\lit{Sollicitis animis onus eximit}{It easeth a burdened soul}, nothing
...
\begin{minipage}[c]{0.4\textwidth}%
\begin{latin}%
\begin{prescriptionbox}{confect}{cum syrup, de cort. citri; fiat \emph{electuarium}}
\item alkermes ℥\marginrecipe{℥: ounce}[-1\baselineskip]\marginrecipe{ß: \emph{semis}, half}ß,
\item lap. bezoar. ℈\marginrecipe{℈: scruple}j,
\item succini albi subtiliss. pulverisat. ℈jj\marginrecipe{j: unit}
\end{prescriptionbox}%
\end{latin}%
\end{minipage}%
\begin{minipage}[c]{0.4\textwidth}
...
\begin{minipage}[c]{0.4\textwidth}%
\begin{latin}%
\begin{prescriptionbox}{\authorfootnote{4331}}{misce cum syrupo de pomis}
\item Diamoschi dulcis et amari ana ʒjj,
\item Diabuglossati, Diaboraginati, sacchari violacei ana j,
\end{prescriptionbox}%
\end{latin}%
\end{minipage}%
\begin{minipage}[c]{0.4\textwidth}
...
it. \lit{Quid aranea cum febre?}{For what antipathy?} till at length rambling
...
\begin{minipage}[c]{0.4\textwidth}%
\begin{latin}%
\begin{prescriptionbox}{}{mista fiat potio ad horam somni sumenda}
\item diacodii ℥j,
\item diascordii ʒß,
\item aquae lactucae ℥iijß,
\end{prescriptionbox}%
\end{latin}%
\end{minipage}%
\begin{minipage}[c]{0.4\textwidth}
...
Rulandus calls Requiem Nicholai \lit{ultimum refugium}{the last refuge}; but
...
\item lithar. argent. unc. j,
\item cerussae candidissimae, ʒjjj,
\item caphurae, ℈jj,
\item dissolvantur aquarum solani, lactucae, et nenupharis ana unc. jjj,
\item aceti vini albi. unc. jj,
\item aliquot horas resideat, deinde transmittatur per philt,
\item aqua servetur in vase vitreo, ac ea bis terve facies quotidie irroretur,
\end{prescriptionbox}%
\end{latin}%
\end{minipage}%
\begin{minipage}[c]{0.4\textwidth}
...
\begin{minipage}[c]{0.4\textwidth}%
\begin{latin}%
\begin{prescriptionbox}{}{misce, utatur mane}
\item Nucleorum persic. seminis melonum ana unc. ℈ß,
\item aquae fragrorum l. ij,
\end{prescriptionbox}%
\end{latin}%
\end{minipage}%
\begin{minipage}[c]{0.4\textwidth}
...
\begin{minipage}[c]{0.4\textwidth}%
\begin{latin}%
\begin{prescriptionbox}{}{misce}
\item Elect. lenit, e succo rosar. ana ℥ j,
\end{prescriptionbox}%
\end{latin}%
\end{minipage}%
\begin{minipage}[c]{0.4\textwidth}
