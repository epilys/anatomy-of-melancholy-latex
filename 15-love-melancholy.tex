\chapter{Love-Melancholy}\label{ch:love-melancholy}
%SECT. II. MEMB. I.
...
to be Love's parents,\authormarginnote{4634} before the Gods were born: \li{Ante deos omnes primum
generavit amorem.} Some think it is the self-same fire Prometheus
fetched from heaven. \li{Plutarch amator. libello}, will have Love to be the
...
Agatho the rhetorician, \li{magniloquus Agatho}, that chanter Agatho, had
...
should have it; but they made answer, \li{O Vulcane faber Deorum}, \etc{}. O
...
power and sovereignty is expressed by the poets,\authormarginnote{4641} in that he is
held to be a god, and a great commanding god, above Jupiter himself;
\li{Magnus Daemon}, as Plato calls him, the strongest and merriest of all
the gods according to Alcinous and \authorfootnote{4642}Athenaeus. \li{Amor virorum rex,
...
in his temples, worship his image, (\li{numen enim hoc non est nudum nomen})
...
\end{verse}%
\end{latin}
\translationrule%\setauthornote{4650}
\begin{verse}%
...
for love; that as \authorfootnote{4651}Lucian's Juno right well objected to him, \li{ludus
amoris tu es}, thou art Cupid's \worddef{a toy that whirls, revolves}{whirligig}: how did he insult over all
...
\authorfootnote{4655}\li{ubi mulieribus blanditiis permittunt se, et inquinantur
...
\end{verse}%
\end{latin}
\translationrule%\setauthornote{4658.5}
\begin{verse}%
...
\end{verse}%
\end{latin}
\attrib{\getauthornote{4663}}

Common experience and our sense will inform us how violently brute
beasts are carried away with this passion, horses above the rest,-\li{furor
...
them to sing \li{ob futuram venerem} for joy or in hope of their venery
which is to come.
...
they, tritons,\authormarginnote{4669} \li{stupri causa} would set upon them and carry them to
...
\end{verse}%
\attrib{\getauthornote{4728}}

And she again to him, as the \authorfootnote{4729}Bride saluted the Bridegroom of old
in Rome, \li{Ubi tu Caius, ego semper Caia}, be thou still Caius, I'll be
Caia.
...
\end{verse}%
\end{latin}
\translationrule%\authorlatintrans{4736}
\begin{verse}%
...
\end{verse}%
\end{latin}
\translationrule%\authorlatintrans{4738}
\begin{verse}%
...
by \authorfootnote{4763}\idxname{mersenne}[Marinus Marcennus], a malapert friar, and some others (which
...
obscaenus}. So far Cardan of himself, \li{quod de se fatetur ideo} \authorfootnote{4766}\li{ut
utilitatem adferat studiosis hujusce disciplinae}, and for this he is
traduced by \idxname{mersenne}[Marcennus], when as in effect he saith no more than what
Gregory Nazianzen of old, to Chilo his scholar, \li{offerebant se mihi
...
perfecta, inquit commentator ejus Cardanus. Tho. \idxname{campanella}[Campanella][\textlatin{Astrologicorum}] Astrologiae
...
\end{verse}%
\end{latin}
\attrib{\getauthornote{4781}}

Idleness overthrows all, \li{Vacuo pectore regnat amor}, love tyranniseth in
an idle person. Amore abundas Antiphio. If thou hast nothing to
do,\authorfootnote{4782} \li{Invidia vel amore miser torquebere}-Thou shalt be haled in
pieces with envy, lust, some passion or other. \li{Homines nihil agendo
male agere discunt}; 'tis Aristotle's simile, \authorfootnote{4783}as match or
touchwood takes fire, so doth an idle person love. \li{Quaeritur Aegistus
...
\li{Luxurians opibus more hominum mulier agit}: she was rich, fortunate and
...
describes it, \li{Juventa gignitur, juxu nutritur, feriis alitur, otioque
...
\begin{latin}
\authorfootnote{4791}Vinum imprimis generosum,
...
\end{verse}%
\attrib{\getauthornote{4839}}

It captivates the very gods themselves, \li{Morosiora numina},
...
\end{verse}%
\end{latin}
\translationrule%\authorlatintrans{4840.5}
\begin{verse}%
The king of the gods
on account of this beauty became a bull, a shower, a swan.
\end{verse}%
\attrib{\getauthornote{4840}}
...
\end{verse}%
\end{latin}
\translationrule%\authorlatintrans{4853}
\begin{verse}%
...
\end{verse}%
\end{latin}
\translationrule%\authorlatintrans{4854.5}
\begin{verse}%
...
fiction of it, at which the spectators were amazed. \authorfootnote{4863}\li{Miseri quibus
...
\translationrule%
\begin{verse}%
A fair woman overcomes fire and sword.\authormarginnote{4898.4}
\end{verse}%
\attrib{\getauthornote{4898}}

\begin{figure}[tbh]
  \begingroup
  \centering
  \includegraphics[keepaspectratio,width=0.6\textwidth]{pride-JudithHolofernes-small.jpg}
...
A modern poet brings in Amnon complaining of Thamar,\authorfootnote{4941}
...
Illae aemulantes purpuram, et rosas genae,\authormarginnote{4942}
...
worse: which \authorfootnote{4950}\idxname{polydorevergil}[Polydore Virgil] taxeth in our nation: Angli ut
...
\end{verse}%
\end{latin}
\translationrule%\setauthornote{4989.5}
\begin{verse}%
...
But whither away God knows,\authormarginnote{4991}
---look out, \etc{}, \li{et quae sequuntur},
\end{verse}%
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5086.5}
\begin{verse}%
The mind is delighted
as much by eloquence as beauty.
\end{verse}%
\attrib{\getauthornote{5086}}
...
counterfeited honesty, as if I had been \li{virgo virginissima}, more than a
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5102.5}
\begin{verse}%
Only attempt to touch her person,
and immediately your members
will be filled with a glow of delicious warmth.
\end{verse}%
\attrib{\getauthornote{5102}}

Especially when they shall be lasciviously given, as he feelingly said,
\authorfootnote{5103}\li{et me praessulum deosculata Fotis, Catenatis lacertis}, \authorfootnote{5104}
\li{Obtorto valgiter labello.}
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5144.5}
\begin{verse}%
...
\end{verse}
\end{latin}
\translationrule%setauthornote{5205.5}
\begin{verse}%
Three hundred verses would not comprise their indecencies.
\end{verse}%
\attrib{\getauthornote{5205}}
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5212.5}
\begin{verse}%
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5237.5}
\begin{verse}%
...
\end{verse}%
\attrib{\getauthornote{5349}}

For fire, saith \authorfootnote{5350}Xenophon,
...
\end{verse}
\end{latin}
\translationrule%\authorlatintrans{5364}
\begin{verse}%
The shuttle stops,
and the web hangs unfinished from her hands.
\end{verse}%
\attrib{\getauthornote{5364}}
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5365.5}
\begin{verse}%
...
\end{verse}
\end{latin}
\attrib{\getauthornote{5396}}

\begin{verse}%
Fairest of fair, that fairness doth excel.
\end{verse}%
\attrib{\getauthornote{5397}}
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5405}
\begin{verse}%
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5425}
\begin{verse}%
...
\end{verse}
\end{latin}
\translationrule%\authorlatintrans{5459.5}
\begin{verse}%
Some token snatched from her arm;
or her gently resisting finger.
\end{verse}%
\attrib{\getauthornote{5459}}
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5463.5}
\begin{verse}%
Ye alpine winds, ye mountain breezes,
bear these gifts to her.
\end{verse}%
\attrib{\getauthornote{5463}}
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5479}
\begin{verse}%
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5509.5}
\begin{verse}%
...
lie, dissemble or excuse it, yet \li{homo sum}, \etc{}, not altogether inexpert
in this subject, non sum praeceptor amandi, and what I say, is merely
reading, \li{ex altorum forsan ineptiis}, by mine own observation, and
others' relation.

%MEMB. IV.

\emph{Prognostics of Love-Melancholy.} % FIXME
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5592}
\begin{verse}%
...
\begin{latin}%
\begin{prescriptionbox}{}{confec. solida in morsulis}
\item seminis lactuc,
\item portulac. coriandri an. ʒj,
\item menthae siccae ʒß,
\item sacchari albiss. ℥iiij,
\item pulveriscentur omnia subtiliter, et post ea simul misce aqua neunpharis, f,
\end{prescriptionbox}%
\end{latin}%
\end{minipage}%
\begin{minipage}[c]{0.4\textwidth}
\begin{latin}
\begin{prescriptionbox}{FIXME translation}{confec. solida in morsulis}
\item seminis lactuc,
\item portulac. coriandri an. ʒj,
\item menthae siccae ʒß,
\item sacchari albiss. ℥iiij,
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5666.5}
\begin{verse}%
Depart, and take a long journey
-safety is in flight only.
\end{verse}%
\attrib{\getauthornote{5666}}
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5698.5}
\begin{verse}%
For what limit has love?
\end{verse}%
\attrib{\getauthornote{5698}}

But, without question, good counsel and advice must needs be of great force,
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5708}
\begin{verse}%
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5722.5}
\begin{verse}%
When the wrinkled skin becomes flabby,
and the teeth black.
\end{verse}%
\attrib{\getauthornote{5722}}
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5747}
\begin{verse}%
...
\end{verse}
\end{latin}%\setauthornote{5751.5}
\begin{verse}%
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5761}
\begin{verse}%
...
they will not be ruled. Think but of that old proverb, \textgreek{ᾑρώων τέκνα
πήματα}, \li{heroum filii noxae}, great men's sons seldom do well; \li{O utinam
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5801.5}
\begin{verse}%
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5844}
\begin{verse}%
...
both parties well pleased, there is \lit{mutuus amor}{mutual love} and great
...
\lit{Volat irrevocabile tempus}{Time past cannot be recalled}. But we need no
...
Junctine, Protanus, \idxname{campanella}[Campanella], what the rest, (to omit those Arabian
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5939.5}
\begin{verse}%
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5942}
\begin{verse}%
...
\begin{latin}
\begin{verse}
Ite, agite, O juvenes, non murmura vestra columbae,\authorfootnote{5976}
...
\end{verse}
\end{latin}
\translationrule%\setauthornote{5979}
\begin{verse}%
Happy both, if my verses have any charms,
nor shall time ever detract from the memorable example of your lives.
\end{verse}%

\li{Atque haec de amore dixisse sufficiat, sub correctione, \authorfootnote{5980}quod ait
